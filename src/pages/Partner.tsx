...
const Partner = () => {
  ...
  const exploreList = [
    ...
    { title: "Goldman Sachs Group (Depository)", logo: "partners_logo/Goldman.png", description: "Goldman Sachs Group, Inc is a multinational investment banking and financial services company that is partnered with Spade Enterprise Ltd to assure the protection of our real estate assets, with access at any time under the instructions of an authorized Spade Enterprise Ltd director to liquidate and to be sold to Goldman Sachs Group Inc or their associates. Goldman Sachs is sanctioned and regulated by the Board of Governors of the Federal Reserve System (Federal Reserve Board), the FDIC, and the New York State Department of Financial Services."},
    { title: "Citi (Custodian)", logo: "partners_logo/Citibank.png", description: "Citigroup Inc. is an American multinational investment bank and financial services corporation that is that regulated by the Office of the Comptroller of the Currency (OCC) and Federal Reserve Bank of New York (FRBNY). Citigroup Inc. is a trusted member of Spade's safeguarding division to protect Spade Enterprise Ltd’s United States Dollar deposits. In California, CLA does business as Citigroup Life Insurance Agency, LLC the license number is 0G56746"},
    ...
    { title: "Amazon Web Servers", logo: "partners_logo/Amazon.png", description: "AWS provides even the most security-sensitive organizations with reliable cloud infrastructure. ISO 27001 and SOC 2 are just a couple of examples from the list of assurance programs with which AWS complies."},
    { title: "Cloudflare", logo: "partners_logo/Cloudflare.png", description: "Cloudflare is a trusted security partner providing protection from critical vulnerabilities and threats, safeguarding network infrastructure against layer 3 and layer 4 DDoS attacks, and securing our team’s devices, networks, and internal applications."},
    { title: "Gemini Custody (Streamline participant, custodian)", logo: "partners_logo/Gemini.png", description: "Gemini Trust Company, LLC is a New York trust company regulated by the New York State Department of Financial Services (NYDFS). Gemini Custody protect the Spade Enterprise Ltd the client GUSD (Gemini USD) holdings and is responsible for the streamlining conversion from USD to GUSD when instructed by Spade Enterprise Ltd, Spade will only commit to this instruction if we borrowers prefer the credit-line use of a stablecoin, or to comply with the User Agreement. Gemini is subject to anti-money laundering, capital reserve, consumer protection, and cybersecurity requirements, as well as banking compliance standards set forth by the NYDFS and New York Banking Law."},
